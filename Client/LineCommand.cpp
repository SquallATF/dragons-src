...
{	//< CSD-030311 : ¿µ¾î´Â ´ë¹®ÀÚ·Î ½áÁÖ¼¼¿ä..
	...
	{"", LC_CHAT_PARTY},				// µ¿·á											
	{"", LC_CHAT_GUILD},				// ±æµå¿¡°Ô								
	{"", LC_TOTAL_MAP_CONNECTIONS},		// ¸ÊÇöÀçÀÎ¿ø								
	{"", LC_TOTAL_CONNECTIONS},			// ÇöÀçÀÎ¿ø											
	{"", LC_TOTAL_CONNECTIONS},			// ´©±¸											
	{"", LC_TOTAL_CONNECTIONS},			// USER												
	{"", LC_MAKE_PARTY},				// PARTY											
	{"", LC_MAKE_PARTY},				// ÆÄÆ¼													
	{"", LC_DEFAULT_WALK},				// °È±â													
	{"", LC_DEFAULT_WALK},				// ±âº»°È±â													
	{"", LC_DEFAULT_RUN},				// ´Þ¸®±â												
	{"", LC_DEFAULT_RUN},				// ±âº»´Þ¸®±â											
	{"", LC_TAME_STOP},					// ½¬¾î												
	{"", LC_TAME_STOP},					// ±×¸¸																
	{"", LC_TAME_STOP},					// STOP														
	{"", LC_TAME_ATTACK},				// °ø°ÝÇØ													
	{"", LC_TAME_ATTACK},				// ATTACK												
	{"", LC_TAME_FOLLOWME},				// µû¶ó¿Í											
	{"", LC_TAME_FOLLOWME},				// FOLLOW												
	{"", LC_TAME_NAME},					// ³×ÀÌ¸§Àº												
	{"", LC_TAME_NAME},					// NAME											
	{"", LC_OPEN_TIMEMENU},				// ½Ã°£º¸±â								
	{"", LC_OPEN_TIMEMENU},				// TIME 								
	{"", LC_CLOSE_TIMEMENU},			// ½Ã°£²ô±â									
	{"", LC_CLOSE_TIMEMENU},			// ½Ã°£´Ý±â											
	{"", LC_OPEN_TIMEMENU},				// ½Ã°£										
	{"", LC_CLOSE_ALL},					// OFF													
	{"", LC_EAR_MESSAGE_REFUSE_WHO},	// °ÅºÎ»ó´ë												
	{"", LC_EAR_MESSAGE_REFUSE},		// ±Ó¼Ó¸»°ÅºÎ									
	{"", LC_EAR_MESSAGE_OK},			// ±Ó¼Ó¸»Çã¶ô									
	{"", LC_REPRINT_EAR_MESSAGE},		// ÂÊÁö				
	{"", LC_GREETING},					// ÀÎ»ç¸» 								
	{"", LC_EXPLAIN_CLOSE},				// ¼³¸í´Ý±â																
	{"", LC_EXPLAIN_CLOSE},				// ¼³¸í²ô±â									
	{"", LC_EXPLAIN_OPEN},				// ¼³¸íº¸±â					
	{"", LC_REQ_MAN_TO_MAN},			// °áÅõ						
	{"", LC_RESET_MAGIC_ARRAY},			// ½ÅÀÇ±Ç´É 						
	{"", LC_RESET_MAGIC_ARRAY},			// ¸¶¹ýÀç¹èÄ¡										
	{"", LC_MSG_ALL_NATION},			// ¸ðµÎ							
	{"", LC_GUILD_EXIT},				// ±æµåÅ»Åð					
	{"", LC_GUILD_JOIN},				// ±æµå°¡ÀÔ						
	{"", LC_GUILD_ALL_MSG},				// ±æµå¸ðµÎ					
	{"", LC_GUILD_ALL_MSG},				// ±æµå°øÁö					
	{"", LC_GUILD_CHANGE_EACH_LEVEL},	// ±æµåµî±Þ							
	{"", LC_GUILD_CMD_INFO},			// ±æµå¸í·É
	{"", LC_CHANGE_JOB},				// Á÷¾÷¹Ù²Ù±â
	{"", LC_CHANGE_JOB},				// Á÷¾÷±³Ã¼						
	{"", LC_STOP_WAR},					// ÈÞÀü
	{"", LC_SCAN_TARGET_VYSEUS},		// ¾ß»ç½ºÀÇ ´«ÀÌ¿©
	{"", LC_SCAN_TARGET_ZYPERN},		// ´Ò¸²ÀÇ ÀÇÁö¿©
	{"", LC_KILL_CHARACTER},			// ÈÞ½Ä
	{"", LC_DIRECTIONS},				// ¹æÇâ
	{"", LC_OPEN_DISPLAY_SKILL_EXP},	// ½ºÅ³º¸±â
	{"", LC_CLOSE_DISPLAY_SKILL_EXP},	// ½ºÅ³´Ý±â
	{"", LC_OPEN_DISPLAY_TAC_EXP},		// ÅÃÆ½º¸±â
	{"", LC_CLOSE_DISPLAY_TAC_EXP},		// ÅÃÆ½´Ý±â
	{"", LC_LIGHTOFRESCUE},				// ±¸¿øÀÇºû
	{"", LC_AUTOLEVELUP_CLOSE},			// ÀÚµ¿ÇØÁ¦
	{"", LC_AUTOLEVELUP_OPEN},			// ÀÚµ¿ºÐ¹è							
	{"", LC_ANNONCE_ON},			    // µµ¿ò¸»µè±â
	{"", LC_ANNONCE_OFF},			    // µµ¿ò¸»²ô±â
	{"", LC_EAR_COMMAND_INFO},		    // ±Ó¼Ó¸»
	{"", LC_FIGHTMAP_ALL_CHAT},		    // ÀüÃ¼
	{"", LC_SMALL_TIPS},			    // µµ¿ò
	{"", LC_SMALL_TIPS},			    // HELP
	{"", LC_SMALL_TIPS},			    // ?
	{"", LC_EMOTION},				    // °¨Á¤
	{"", LC_EXIT_GUILD},
	{"", LC_VIEW_NK},				    // NK ¼öÄ¡ º¸±â
	{"", LC_SQUAD_LEADER},			    // »ç·É°ü -> ºÎ´ëÀå
	{"", LC_SQUAD},					    // »ç·É°ü -> ºÎ´ë
	{"", LC_SQUAD_MEMBER},              // ºÎ´ëÀå -> ºÎ´ë¿ø
	{"", LC_SQUAD_MEMBER_TO_MEMBER},    // ºÎ´ë¿ø -> ºÎ´ë¿ø	
	{"", LC_WAR_MENU_OPEN},		        // War Menu Open
	{"", LC_WAR_MENU_NOTICE_OPEN},	    // War Menu NOTICE
	{"", LC_GUILD_MAIL},			    // ±æµå¸ÞÀÏ
	{"", LC_SQUAD_CHAT},			    // 010915 LTS	//ÀÓ½Ã
	{"", LC_GUILD_CHAT},			    // #
	{"", LC_COMMANDER_INFO},		    // 010924 LTS
	{"", LC_SQUAD_INFO},			    // 010924 LTS	
	{"", LC_GUILD_CHAT_ON},		        // ±æµåÃ¤ÆÃÄÑ±â
	{"", LC_GUILD_CHAT_OFF},		    // ±æµåÃ¤ÆÃ²ô±â
	{"", LC_RESET_ABILITY},		        // ¾îºôÀçºÐ¹è
	{"", LC_WAR_GIVE_LIFE},		        // 011015 LTS	// ÀüÀïÅÍ À¯·É »ì¸®±â // ºÎÈ°
	{"", LC_PARTY_ALL_FREE},		    // ÆÄÆ¼ÇØÁ¦
	{"", LC_SEND_GUILD_MAIL},	        // ±æµå¸ÞÀÏº¸³»±â
	{"", LC_SEND_MAIL},		 	        // ¸ÞÀÏº¸³»±â
	{"", LC_SHOW_ME_DUAL},		  	    // ¾îµÒÀ» °È°í ½Ã°£À» ´Þ¸°´Ù
	{"", LC_REPORTER_MODE},			    // ±âÀÚ¸ðµå
	{"", LC_FRIEND_MENU},			    // Ä£±¸
	{"", LC_WAR_GIVE_LIFE2},		    // ºÎÈ°Àå¼Ò				// 011213 LTS	N_YILSE
	{"", LC_SCAN_TARGET_YILSE},		    // 011217 LTS
	{"", LC_GETCOLOSSUS_INFO},		    // ÄÝ·Î¼­½º, 
	{"", LC_GETCOLOSSUS_INFO},		    // colossus, 
	{"", LC_INVITE_COLOSSUS},		    // ÃÊ´ë 
	{"", LC_JOIN_COLOSSUS},			    // Âü°¡
	{"", LC_PK_ON_OFF},				    // PK
	{"", LC_COMBAT_SKILL_ON_OFF},	    // PK//020420 lsw
	{"", LC_LOCALWAR_CHAT},			    // ±¹ÁöÀü	%		// LTS NEW LOCALWAR
	{"", LC_QUESTMODE},				    // LTS DRAGON MODIFY
	{"", LC_WEATHER_ON}, // CSD-CN-031215 : ³¯¾¾È¿°úÄÑ±â
	{"", LC_WEATHER_OFF}, // CSD-CN-031215 : ³¯¾¾È¿°ú²ô±â
	...
	{"", LC_REPRINT_NORMAL_CHAT},	    // º¸ÅëÂÊÁö
	{"", LC_REPRINT_GUILD_CHAT},	    // ±æµåÂÊÁö
	{"", LC_REPRINT_GUILD_BBS},	        // ±æµå°øÁöÂÊÁö
	{"", LC_TRADE},			            // 020808 YGI 
	{"", LC_CHECK_DUAL_FAME},		    // µà¾ó¸í¼º     // LTS DUAL FAME
	{"", LC_WHAT_QUEST_IN_MAP},	        // 021007	//¸Ê¿¡ ¾î¶² Äù½ºÆ®°¡ ÀÖ´Â°¡?
	{"", LC_MERCHANT_BBS},		        // 021022 »óÀÎ°ú Á÷Á¢ °Å·¡
	{"", LC_MERCHANT_EXCHANGE},		    // 021022 »óÀÎ°ú °Å·¡
	...
	//>>kyo
	{"", 0},  //Î»ÖÃ²»×¼,ÉÏÃæµÄÓÐÐ©É¾³ýµôÁË,¼Ó¸ö0À´Ìî³ä
	{"", 0},  //Î»ÖÃ²»×¼,ÉÏÃæµÄÓÐÐ©É¾³ýµôÁË,¼Ó¸ö0À´Ìî³ä
	{"", LC_LINERESET_POINT}, //ÔÂÉñÒ¹090822
	{"", LC_MINIWINDOW_MODE}, //ÔÂÉñÒ¹090822
	{"", LC_MAXWINDOW_MODE}, //ÔÂÉñÒ¹090822
...
{	
	//if( Hero->viewtype == VIEWTYPE_GHOST_ )// À¯·ÉÀÏ °æ¿ì
	//	return ;		// ¸í·É¾î¸¦ ¸ø ÇÏ°Ô ÇÑ´Ù.
	int c; 
	LPLINECOMMAND lc;
	LPCHARACTER ch = Hero;
	char *t, *t1;
	...
	{		
		if( 0 == _strnicmp( lc->reserved, message, strlen( lc->reserved )) )//020926 lsw
		{
			...
			case LC_CHANGE_JOB:
				{
					break;//021126 lsw Á÷¾÷ ¹Ù²Ù±â Ä¿¸àµå ¾øÀ½
				}
			case LC_STOP_WAR:
				{
					SendReqStopWar(t1);
			...
			case LC_INVITE_COLOSSUS:
				{	//< CSD-030521
					if (!g_pArenaManager->IsLeader(Hero->id)) // ¸®´õ°¡ ¾Æ´Ï¶ó¸é
					{
			...
			case LC_WHAT_QUEST_IN_MAP:	// 021007 kyo //Äù½ºÆ®Á¤º¸¸¦ º»´Ù. 
				{
			...
			case LC_MERCHANT_BBS://021126 lsw
				{
					if (Hero->viewtype == VIEWTYPE_GHOST_) //´Ù¸¥ »ç¶÷Àº °í½ºÆ® ÀÌ¸ç	(µý»ç¶÷Àº À¯·É)
					{
						break;
					}
			...
			case LC_GAME_CONGRAGULATION:
				{
					::SendSmileFace((lc->command) - LC_EMOTI_SMILE + 2); // ¾ó±¼¾ÆÀÌÄÜÀÌ 1ºÎÅÍ ½ÃÀÛÇÑ´Ù.
					break;
				}
			...
			case LC_LINERESET_POINT: //ÓÎÏ·ÖÐÖØ·ÖµãÊý.ÔÂÉñÒ¹090822
				{
					Kein_PutMessage(KM_INFO, kein_GetMenuString(229));
					//	CallSmallMenu(MN_INIT_ABILITY);//´ò¿ªÄÜÁ¦´°¿Ú
					CallServer(CMD_RESET_ABILITY);//·¢ËÍÖØ·Öº¯Êý
					CallMenu(MN_ABILITY);//´ò¿ªÊôÐÔ²Ëµ¥
					//CallServer(CMD_OPEN_ABILITY);
					break;
				}
			case 	LC_MINIWINDOW_MODE:	//ÔÂÉñÒ¹090822,×îÐ¡»¯´°¿Ú
				{
		...
		//		SysInfo.dx = 0;
				...
				ShowWindow(g_hwndMain,SW_MINIMIZE);//±Ø²»¿ÉÉÙ£¬·ñÔò½çÃæ»á±äÂÒ,ÕâÀïÏÈ×îÐ¡»¯Ò»ÏÂ´°¿Ú
				ShowWindow(g_hwndMain,SW_MAXIMIZE);//±Ø²»¿ÉÉÙ£¬·ñÔò½çÃæ»á±äÂÒ,È»ºóÕâ×î´ó»¯Ò»ÏÂ´°¿Ú,¾Í¼¤»îÁË
				}
				else
				{
					Kein_PutMessage(KM_INFO, kein_GetMenuString(231));//Õâ¸öÊÇ¶ÁÈ¡MENUSTRING.TXTÀïÏûÏ¢µÄ,¿ÉÒÔ×Ô¼º¼Ó
				}
					break;
				}
			case	LC_MAXWINDOW_MODE:	//ÔÂÉñÒ¹090822,×î´ó»¯´°¿Ú
				{
...
void SendExitGuild()
{
	...
	if( CheckGuildMaster( Hero ) ) return;		// ±æ¸¶´Â ÇÏÁö ¸øÇÏ°Ô..
...
void RecvGuildChatData( t_packet *p )
{
	...
	{
		// ±æµå¿øÀÌ ¸Þ½ÃÁö¸¦ º¸³Â½À´Ï´Ù. ±æµå Ã¤ÆÃ ¸í·É¾î¸¦ ÀÌ¿ëÇÏ¼¼¿ä /#, /±æµåÃ¤ÆÃÄÑ±â, /±æµåÃ¤ÆÃ²ô±â
