...
void ShowMonsterWarInfo()
{
	...
	for(int i = 0; i < 3; i++, x += 70)
	{
		...
		{
		case 0:
			_itoa(g_aRemainGuard[TEAM2][0], szGuardCount, 10);
			::HprintBold( x, y-22, ::Convert16to32(FONT_COLOR_WHITE) ,::Convert16to32(FONT_COLOR_BLACK), \
				szGuardCount);
			break;

		case 1:
			_itoa(g_aRemainGuard[TEAM2][3] + g_aRemainGuard[TEAM2][1], szGuardCount, 10);
			::HprintBold( x, y-22, ::Convert16to32(FONT_COLOR_WHITE) ,::Convert16to32(FONT_COLOR_BLACK), \
				szGuardCount);
			break;

		case 2:
			_itoa(g_aRemainGuard[TEAM2][2], szGuardCount, 10);
			::HprintBold( x, y-22, ::Convert16to32(FONT_COLOR_WHITE) ,::Convert16to32(FONT_COLOR_BLACK), \
				szGuardCount);
			break;
		}
