...
#define SCREEN_METERS	D3DVALUE( 16 )						//(How many meters wide is the screen?)
#define PPM				D3DVALUE( 600.f / SCREEN_METERS )		//How many pixels per meter?
#define MPP				D3DVALUE( SCREEN_METERS / 600.f )		//How many meters per pixel?
#define P2M( x )		D3DVALUE( D3DVALUE( x ) * MPP )			//converts pixels to meters
#define M2P( x )		D3DVALUE( D3DVALUE( x ) * PPM )			//converts meters to pixels
