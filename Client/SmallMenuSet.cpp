...
// 기부 메뉴  : 허트 비트를 준다.
	...
	SMenu[MN_SALVATION2].nField[8].x=102-6;
	SMenu[MN_SALVATION2].nField[8].y=214-5;
	...
	SetRect(SMenu[MN_SALVATION2].nField[8].rCheakBox,96,207,111,219);
						// down
	SMenu[MN_SALVATION2].nField[9].nType=FT_DO;
	SMenu[MN_SALVATION2].nField[9].nWillDo = DO_BANK_SCROLL_DOWN;
	SMenu[MN_SALVATION2].nField[9].x=102-6;
	SMenu[MN_SALVATION2].nField[9].y=228-5;
	...
	SetRect(SMenu[MN_SALVATION2].nField[9].rCheakBox,96,221,111,234);
