...
extern void SetRect(RECT &rect,int left, int top, int right, int bottom);    //¸Þ´º ±¸¼º¿ä¼ÒÀÇ Ãæµ¹Ã¼Å© rectÇü¿¡ °ª ´ëÀÔ
...
int LoadMenuImage()
{
	...
	if( fp )
	{
		...
		while( fgets( temp, 512, fp ) )
		{
			...
			if( !token ) continue;
			index = atoi( token );
			if( index > max_index ) max_index = index;		// 10000 ÀÌ»óÀÌ¾î¾ß ÇÑ´Ù.
...
{
	LoadOpenningSpr( file_name, &buf, spr, image_max );					// ÅõÇ¥
	return 1;
}
// 020701 YGI
...
int CMenuVariable::clear()
{
	...
	bCheckSalvation = 0;
	g_Menu_Variable.set_bCheckSalvation(bCheckSalvation);//ÎÞÏÞÃûÉù
...
int CMenuVariable::LoadingGuildRegistExplain( char *szFileName )
{
	...
	if( GetSysInfo( SI_GAME_MAKE_MODE  ) )
	{
		if( nLine >= 100 ) 
		{
			JustMsg( "guild_explain1.txt ¿¡ ¼³¸íÀÌ ³Ê¹« ¸¹½À´Ï´Ù." ); 
			return 0;
		}
	}
...
{
	/////////////////////////////////////////////////////////////////////////////////////////////////
	//////// ¸ÞÀÎ ÀÎÅÍÆäÀÌ½º ÆÄÆ¼¿ø ¸Þ´º¿¡¼­ ¼±ÅÃ ¶óÀÌÆ® Ãâ·Â
	...
	////////////////////////////////////////////////////////////////////////////////////////////
	// ¸ÞÀÎÀÎÅÍÆäÀÌ½ºÀÇ system¸Þ´º¿¡¼­ ±ÛÀÚ
	...
	////////////////////////////////////////////////////////////////////////////////////////////
	// ¸ÞÀÎÀÎÅÍÆäÀÌ½ºÀÇ system¸Þ´º¿¡¼­ help±ÛÀÚ
			...
			SetRect(SMenu[MN_RELATION].nField[3].rCheakBox,117,44,203,69);
			  ...
			  SetRect(SMenu[MN_RELATION].nField[4].rCheakBox,216,44,302,69);
				...
				SMenu[MN_RELATION].nField[5].nImageNumber=850;
				  ...
				  //´Ù¸¥ ÆÄÆ¼¿øµé Ãâ·Â :
				  // ¸ÕÀú °¡±îÀÌ¸¸ °¡µµ ¼ýÀÚ ÇÊµåÀÇ ¼ýÀÚ¿¡ ºÒÀÌ µé¾î¿Â´Ù. 1¹ø
				  // ´Ù¸¥ Ä³¸¯ÅÍ¿Í °ü°è°¡ ÀÖ´Ù¸é nSpecialWillDo¸¦ Ã¼Å©(true)ÇØ µÐ´Ù			// origin ÁÂÇ¥·Î ÀÌ¹ÌÁö¸¦ Âï´Â´Ù.
						...
						SetRect(SMenu[MN_RELATION].nField[9].rCheakBox,25,262,85,332);
						  ...
						  SetRect(SMenu[MN_RELATION].nField[10].rCheakBox,94,262,154,332);
							...
							SetRect(SMenu[MN_RELATION].nField[11].rCheakBox,163,262,233,332);
							  ...
							  // °ü°èµÈ »ç¶÷À» Å¬¸¯ÇßÀ»¶§, ¾ó±¼°ú ½ºÅ³ º¸¿©ÁÖ±â
							  SMenu[MN_RELATION].nField[12].nType=FT_PARTY_FACE;
							  //	SMenu[MN_RELATION].nField[12].nWillDo = ÇöÀç ¼±ÅÃÇÑ ÆÄÆ¼¿ø;
...
//////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////
//½ºÅ×ÀÌÅÍ½º³ª ¾îºô¸®Æ¼ ¸Þ´º¿¡¼­ °¡Ä¡°ü ¹®ÀåÀ» ¼±ÅÃÇßÀ»¶§ ³ª¿À´Â ¸Þ´º
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//¸ÞÀÎÀÎÅÍÆäÀÌ½º¿¡¼­ ½Ã½ºÅÛ ¸Þ´º ¿¡¼­ option
...
// Á¡Âï±â
SMenu[MN_SYSTEM_OPTION].nField[10].nType=FT_HIDE_SPECIAL_WILLDO_PUT;		// Å¬¸¯ÈÄ ¾î¶² ÇÊµå¸¦ ft_nomal putÀ¸·Î ¸¸µç´Ù.
...
SMenu[MN_SYSTEM_OPTION].nField[11].nType=FT_NOMAL_PUT;
...
SMenu[MN_SYSTEM_OPTION].nField[12].nType=FT_HIDE_SPECIAL_WILLDO_PUT;		// Å¬¸¯ÈÄ ¾î¶² ÇÊµå¸¦ ft_nomal putÀ¸·Î ¸¸µç´Ù.
...
SMenu[MN_SYSTEM_OPTION].nField[14].nType=FT_HIDE_SPECIAL_WILLDO_PUT;		// Å¬¸¯ÈÄ ¾î¶² ÇÊµå¸¦ ft_nomal putÀ¸·Î ¸¸µç´Ù.
...
SMenu[MN_SYSTEM_OPTION].nField[16].nType=FT_HIDE_SPECIAL_WILLDO_PUT;		// Å¬¸¯ÈÄ ¾î¶² ÇÊµå¸¦ ft_nomal putÀ¸·Î ¸¸µç´Ù.
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//¸ÞÀÎÀÎÅÍÆäÀÌ½º¿¡¼­ ½Ã½ºÅÛ ¸Þ´º¿¡¼­ help¸Þ´º


/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//¸ÞÀÎÀÎÅÍÆäÀÌ½º¿¡¼­ ½Ã½ºÅÛ ¸Þ´º¿¡¼­ help¸Þ´º¿¡¼­ key
...
SMenu[MN_ITEM_MAKE].nField[2].nImageNumber=DP_NORMAL_PUT;// ³ªÁß¿¡ ½ºÅ³¿¡ µû¸¥ ±¸ºÐÀ» ÁØ´Ù ±×·¡¼­ 

// °á°ú¹° ¾ÆÀÌÅÛ °è¼Ó º¸¿©ÁÖ±â
SMenu[MN_ITEM_MAKE].nField[3].nType = FT_DATA_PUT;
SMenu[MN_ITEM_MAKE].nField[3].nWillDo = 8;			// ¹à°Ô Âï±â
SMenu[MN_ITEM_MAKE].nField[3].x=13;
SMenu[MN_ITEM_MAKE].nField[3].y=44;
SMenu[MN_ITEM_MAKE].nField[3].nImageNumber=DP_ITEM_PUT;
SMenu[MN_ITEM_MAKE].nField[3].nValue=&item_select_result.item_no;		// ¾ÆÀÌÅÛÀ» Âï±â
...
SMenu[MN_ITEM_SELECT].nField[5].nImageNumber=640;		//»óÈ²¿¡ µû¶ó ¹Ù²ñ
...
////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////
//	ÆÄÆ¼¿øµé ¸ÞÀÎ È­¸é¿¡ ¾ó±¼ ¶ç¿ì±â	// ¸ÞÀÎ ¸Þ´º¿¡ ¹°·Á µÐ´Ù... --> str Ç¥½ÃÇÏ´Â °÷¿¡..
//  1¹ø ÆÄÆ¼..
...
//	SMenu[MN_SMALL_MAP].nImageType=SMALL_MAP;//ÀÌ°Å ÀÖÀ¸¸é ¸· ÂïÈû 
...
SMenu[MN_FIGHT_MAP_SIGN].nField[1].nSpecialWillDo = TA_CENTER;		// Á¤·Ä°ª
SMenu[MN_FIGHT_MAP_SIGN].nField[1].nWillDo = FONT_COLOR_NUMBER;		// color °ª
...
SMenu[MN_FIGHT_MAP_SIGN].nField[2].nSpecialWillDo = TA_CENTER;		// Á¤·Ä°ª
SMenu[MN_FIGHT_MAP_SIGN].nField[2].nWillDo = FONT_COLOR_NUMBER;		// color °ª
...
SMenu[MN_FIGHT_MAP_SIGN].nField[3].nSpecialWillDo = TA_CENTER;		// Á¤·Ä°ª
SMenu[MN_FIGHT_MAP_SIGN].nField[3].nWillDo = FONT_COLOR_NUMBER;		// color °ª
...
SMenu[MN_FIGHT_MAP_SIGN].nField[4].nSpecialWillDo = TA_CENTER;		// Á¤·Ä°ª
SMenu[MN_FIGHT_MAP_SIGN].nField[4].nWillDo = FONT_COLOR_NUMBER;		// color °ª
