...
#include "LocalizingMgr.h"	//050224_KCH 마일리지몰 작업
...
extern int Init_TotalDB_SQL(LPSTR szDSN, LPSTR szUID, LPSTR szUPW);	//050224_KCH 마일리지몰 작업
...
extern int GetRowLineOfSQL(const DBType _DBType, const char *table, const char *field, int *RowCount, const char *condition );
...
extern HENV g_hEnv_ChrLogDB;
extern HDBC g_hDBC_ChrLogDB;
extern HENV	g_hEnv_TotalDB;
extern HDBC	g_hDBC_TotalDB;
