...
public:
	...
	CRegenInfo* GetRegenInfo(int nGroup);
	//< CSD-040310
	void Ready(int nEvent);
	void Ready(int nHunt, int nEvent);

	void Regenerate(int nEvent);
	void Regenerate(int nHunt, int nEvent);

	void Remove(int nEvent);
	void Remove(int nHunt, int nEvent);
	//> CSD-040310
public:
