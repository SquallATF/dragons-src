...
*/
		while( retCode == SQL_SUCCESS || retCode == SQL_SUCCESS_WITH_INFO)
		{
			...
			retCode = SQLGetData(hStmt, ++column, SQL_C_LONG,	&m_MRData[iIndex].aInsuranceItemNo[0],	0, &cbValue);
			retCode = SQLGetData(hStmt, ++column, SQL_C_LONG,	&m_MRData[iIndex].aInsuranceItemNo[1],	0, &cbValue);
			retCode = SQLGetData(hStmt, ++column, SQL_C_LONG,	&m_MRData[iIndex].aInsuranceItemNo[2],	0, &cbValue);
