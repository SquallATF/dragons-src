...
NPCName_by_Gender	NPC_Name_Ref[Num_Of_NPC_Name] = { 0, };		//050329_KCH 초기화.
NPCLev_to_Exp		NPC_Lev_Ref[Num_Of_NPC_Lev] = { 0, };			//050329_KCH 초기화.
NPC_Generation		NPC_Gen_Ref[Num_Of_NPC_Generation] = { 0, };	//050329_KCH 초기화.
BYTE				EnemyEnemy[100][100] = { 0, };				//050329_KCH 초기화.

int NPC_FemaleName_Count = 0;
int NPC_MaleName_Count = 0;
int NPC_LastName_Count = 0;
...
int initNPCLevTable(void)
{
	...
	{
		*tt += (sizeof(NPCLev_to_Exp) + i);	//050329_KCH 100 을 이해하기 쉽게 변경
		crc += *tt;
		tt++;
	}
