...
extern BOOL IsNeoWarfieldServer();		// LTH-040225-KO
#include "WarfieldMgr.h"				// LTH-040226-KO
extern CWarfieldMgr* g_pcWarfieldMgr;	// LTH-040225-KO
...
int IsStartNationWar()		// 이 맵이 전투 맵이고 현재 전투 중인가?
{
	...
	//< LTH-040225-KO 이맵이 전투맵이고 현재 국가전이라면 같은편끼리 PK를 못하게 하는 것으로 이해했다
