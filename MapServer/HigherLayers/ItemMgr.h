...
const int  MAX_MONEY = 1000000000;  // 錦맣寧股풀悧鑒
const int  MAX_DIVIDE_ITEM = 1000000000;  // 錦맣寧股풀悧鑒
...
public://아이템 정보 얻는 클래스
	...
	int DecItemDur_ForEquip(ITEMATTR &item, const DWORD iValue);	//<050425_KCH 내구도 뎀쥐증가 버그수정
