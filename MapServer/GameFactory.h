...
public:
	...
	virtual CRaidManager* CreateRaidManager();
	virtual void DestroyRaidManager(CRaidManager* pManager);

	virtual CItemMallManager* CreateItemMallManager();
	virtual void DestroyItemMallManager(CItemMallManager* pManager);
};
//
///////////////////////////////////////////////////////////////////////////////
