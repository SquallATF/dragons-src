...
#define		IK_GON				1	//	곤			
#define		IK_PENCING			2	//	펜싱검		
#define		IK_ONE_SWORD		3	//	한손검
#define		IK_ONE_AXE			4	//	한손도끼
#define		IK_ONE_MACE			5	//	한손철퇴
#define		IK_CLUB				6	//	몽둥이
#define		IK_WHIRL			7	//	봉
#define		IK_STAFE			8	//	지팡이
#define		IK_SPEAR			9	//	보통창
#define		IK_FORK				10	//	포크
#define		IK_HURL				11	//	비검,던지는무기
#define		IK_SHORT_BOW		12	//	소형활
#define		IK_TWO_SWORD		13	//	양손검
#define		IK_TWO_AXE			14	//	양손도끼
#define		IK_TWO_MACE			15	//	양손 철퇴
#define		IK_TWO_ARROW		16	//	화살
#define		IK_IRON_ARMOR		17	//	쇠갑옷
#define		IK_LEATHER_ARMOR	18	//	가죽갑옷
#define		IK_RING				19	//	반지
#define		IK_SHIELD			20	//	방패
#define		IK_SHOES			21	//	신발
#define		IK_ROBE				22	//	로브
#define		IK_FULL_HELMET		23	//	플헬멧
#define		IK_HALF_HELMET		24	//	하프헬멧
#define		IK_NORMAL_CLOTHE	25	//	보통옷
#define		IK_AMULET			26	//	목거리
#define		IK_ARMLET			27	//	팔찌
#define		IK_MUSIC			28	//	악기
#define		IK_SCROLL			29	//	스크롤
#define		IK_LONG_BOW			30	//	대형활
#define		IK_BOX				31	//	상자
#define		IK_GRAIN			32	//	곡식
#define		IK_POTION			33	//	포션
#define		IK_FOOD_MASS		34	//	덩어리 음식
#define		IK_PLATE_FOOD		35	//	쟁반 음식
#define		IK_DRINK			36	//	음료
#define		IK_ARROW_POINT		37	//	화살 촉
#define		IK_FEATHER			38	//	깃털		
#define		IK_SEED				39	//  씨앗.
#define		IK_MONEY			40	//	돈
#define		IK_MINERAL			41	//	광석
#define		IK_MINERAL_LUMP		42	//	가공한 광석( 철괴, 금괴... )
