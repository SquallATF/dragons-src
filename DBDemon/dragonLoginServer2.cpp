...
int CheckHandleByKein( t_packet *p, t_connection c[], int cn )  //ÕâÀïµÄ×÷ÓÃÊÇËùÓÐÁ¬½Ó½øÀ´×÷ÓÃÊ±µÄIDºÅºÍÓÃ»§Ãû
{
	...
	case CMD_SELECT_NATION				:	RecvSelectNation( p, cn ); break;	//×¢²áÐÂÈËÎïÊ±Ñ¡ÔñµÄ¹ú¼Ò
	...
	case CMD_GUILD_MASTER_AND_SUBMASTER		:	RecvGuildMasterAndSubMaster(p, cn ); break; //¹«»á³ÉÔ±ÁÐ±í
...
str="·¢ÏÖSQLÂ©¶´¹¥»÷!·Ç·¨ÄÚÈÝ:[%s],  Éñµî×¢²áÈËÃû³Æ:[%s]";
...
for(i = 0; i < len1; i++)		//¹«»áÃû³Æ
{
 ...
 /*   if(pMailSend->szSender == 'Ð¡ÊÖ±ùÁ¹')
	{
		pMailSend->szSender = 'Ð¡ÊÖ±ùÁ¹';
	}*/
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
str="·¢ÏÖSQLÂ©¶´¹¥»÷!·Ç·¨ÄÚÈÝ:[%s],  Ô¤±¸¹«»áÉêÇëÃû³Æ:[%s],	ÉêÇëÈË:[%s]";
...
str="·¢ÏÖSQLÂ©¶´¹¥»÷!·Ç·¨ÄÚÈÝ:[%s],  ¹«»á¸±»á³¤Ãû³Æ:[%s]";
...
str="·¢ÏÖSQLÂ©¶´¹¥»÷!·Ç·¨ÄÚÈÝ:[%s],  ¼ÓºÃÓÑÈË:[%s], ±»¼ÓºÃÓÑÈË:[%s]";
...
str="·¢ÏÖSQLÂ©¶´¹¥»÷!·Ç·¨ÄÚÈÝ:[%s],  ¹«»áÉêÇëÃû³Æ:[%s]";
