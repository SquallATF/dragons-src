...
const int MIN_GUILD_COUNT = 1;  // CSD-030320  coromo 묏삔瘻攣矜狼훙鑒
//Skill No
enum eSkillNoIndex
{	//< CSD-030306
...
const int MAX_EXP_LEVEL = 200; // CSD-TW-030606
const int MAX_TAC_LEVEL = 499; // CSD-TW-030606
