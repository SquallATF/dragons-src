...
//			PutEventItem( 1, &c[cn] );		// ÀÌº¥Æ®¿ë ¾ÆÀÌÅÛ ³Ö¾î ÁÖ±â	// BBD 040308	Map¼­¹ö°¡ ÁÖ±â·Î ÇßÀ½
			...
			// ¸¶¹ýÀ» ¹è¿ìÁö ¾Ê°í ¸ðµç ¸¶¹ýÀ» »ç¿ëÇÏ·Á¸é ÀÌ°÷¿¡¼­  Ws/Ps¸¦ SettingÇØÁÖ¸é µÈ´Ù. 
...
int CheckIDAutherizing(t_packet &packet, const int cn)
{
	...
	if(bIsGMTool)   //coromo GMµÇÂ½Æ÷±ØÐëÑéÖ¤IDºÍIP
	{
		/*
	...
	case COnePass::BT_WAIT_BILLING_MSG:
		{	//ºô¸µ ¸Þ¼¼Áö¸¦ ±â´Ù¸³´Ï´Ù. ¾Æ¹« Ã³¸®µµ ÇÏÁö ¾Ê½À´Ï´Ù.
			break;
		}
...
/*   //coromo ×¢ÊÍµôÔ­ÏÈµÇÂ½ÅÐ¶ÏID IS LOGIN  2007/04/29
	default:
		{
			WORD wPort = 0;	
			DWORD dwID = 0;	
				 ...
				 int success)		//if login or logout success
{
	...
	else//·Î±×ÀÎ ½ÇÆÐ. ¾ÆÀÌµð¿Í ÆÐ½º¿öµå´Â ¸ÂÀ¸¹Ç·Î ³²Àº°ÍÀº µ·³»´Â °Í »Ó.
	{			
