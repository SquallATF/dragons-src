...
#define PROXY_SERVER_INI_		_T(".\\ProxyServer.ini")
#define SERVER_MANAGER_INI_		PROXY_SERVER_INI_
#define DB_DEMON_INI_			_T(".\\DBDemon.ini")
#define AGENT_SERVER_INI_		_T(".\\agentserver.ini")
#define MAP_SERVER_INI_			_T(".\\MapServer.ini")
